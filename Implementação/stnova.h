...
typedef struct{
    ...
    interacao ** interacoes;            //Vetor de apontadores para as interacoes do remetente, organizadas sob a forma de uma heap
} remetente;
...
/**
 * Cria uma nova interação entre o remetente e um destinatário
 * Retorna o remetente atualizado ou NULL em caso de erro
**/
interacao* nova_interacao(remetente* remet1,char *user2);

/**
 * Adiciona uma mensagem à interação entre dois utilizadores
